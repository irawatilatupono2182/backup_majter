            ...
            <tr>
                ...
                <td style="width: 55%; vertical-align: top; padding-right: 10px;">
                    <div style="font-size: 14px; line-height: 1.5; margin-bottom: 6px;">
                        <strong style="font-weight: bold;">BILL TO  :  <?php echo e(strtoupper($invoice->customer->name ?? 'PT. ARGO MANUNGGAL TRIASTA')); ?></strong>
                    </div>
                    <div style="font-size: 13px; line-height: 1.4; margin-top: 4px;">
                        <?php echo e($invoice->customer->address_bill_to ?? $invoice->customer->address_ship_to ?? 'Wisma Argo Manunggal Lt 2, Jalan Jend. Gatat Subroto Kav 22 Karet Semanggi - Setia budi, Jakarta Selatan, DKI Jakarta 12930, Indonesia'); ?>
                        ...
                        <table style="font-size: 13px; margin-bottom: 6px; margin-left: auto;">
                            <tr>
                                <td colspan="2" style="padding: 2px 0; padding-bottom: 6px; text-align: right;">
                                    <strong>BANDUNG, <?php echo e($invoice->invoice_date ? strtoupper($invoice->invoice_date->translatedFormat('d/F/Y')) : strtoupper(now()->translatedFormat('d/F/Y'))); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 90px; padding: 2px 0; text-align: left;">NO INVOICE</td>
                                <td style="padding: 2px 0; text-align: left;">: <?php echo e($invoice->invoice_number); ?></td>
                            </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->po_number): ?>
                            <tr>
                                <td style="padding: 2px 0; text-align: left;">PO NO.</td>
                                <td style="padding: 2px 0; text-align: left;">: <?php echo e($invoice->po_number); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->payment_terms): ?>
                            <tr>
                                <td style="padding: 2px 0; text-align: left;">TOP</td>
                                <td style="padding: 2px 0; text-align: left;">: <?php echo e($invoice->payment_terms); ?> HARI</td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </table>
                    </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-desc"><?php echo e(strtoupper($item->product->name ?? 'N/A')); ?></td>
                    <td class="col-qty"><?php echo e(number_format($item->quantity ?? 0, 0, ',', '.')); ?> <?php echo e(strtoupper($item->unit ?? 'PCS')); ?></td>
                    <td class="col-price">Rp. <?php echo e(number_format($item->unit_price ?? 0, 0, ',', '.')); ?></td>
                    <td class="col-amount">Rp. <?php echo e(number_format($amount, 0, ',', '.')); ?></td>
                </tr>
        ...
        <div style="text-align: right; padding-right: 0; margin-top: 8px;">
            <table style="font-size: 13px; margin-left: auto; border-collapse: collapse; display: inline-table;">
                <tr>
                    ...
                    <td style="padding: 2px 0; text-align: left;">: Rp. <?php echo e(number_format($grandTotal, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td style="padding: 2px 10px 2px 0; text-align: left;">DPP NILAI LAIN</td>
                    <td style="padding: 2px 0; text-align: left;">: Rp. <?php echo e(number_format(0, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td style="padding: 2px 10px 2px 0; text-align: left;"><strong>PPN</strong></td>
                    <td style="padding: 2px 0; text-align: left;">: Rp. <?php echo e(number_format(isset($invoice->tax) ? $invoice->tax : 0, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td style="padding: 2px 10px 2px 0; border-bottom: 2px solid #000; text-align: left;"><strong>GRAND TOTAL</strong></td>
                    <td style="padding: 2px 0; border-bottom: 2px solid #000; text-align: left;">: <strong>Rp. <?php echo e(number_format($invoice->grand_total ?? $grandTotal, 0, ',', '.')); ?></strong></td>
                </tr>
            </table>
        </div>
...
<?php /**PATH C:\laragon\www\adamjaya\resources\views/pdf/invoice.blade.php ENDPATH**/ ?>